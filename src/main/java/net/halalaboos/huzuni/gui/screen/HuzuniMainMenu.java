...
public class HuzuniMainMenu extends HuzuniScreen {
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(2, this.width / 2 - 100, y + 24 * 1, I18n.format("menu.multiplayer")));
		...
		if (huzuni.settings.hasUpdate()) {
			this.buttonList.add(new HuzuniLink(6, this.width / 2 - mc.fontRendererObj.getStringWidth("Download") / 2, y + 102, mc.fontRendererObj.getStringWidth("Download"), 15,"Download"));
		}
	}
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawString(fontRendererObj, huzuniVersion, width - fontRendererObj.getStringWidth(huzuniVersion) - 2, height - 12, 0x3FFFFFFF);
        this.drawString(fontRendererObj, forgeVersion, width - fontRendererObj.getStringWidth(forgeVersion) - 2, height - 24, 0x3FFFFFFF);
        if (huzuni.settings.hasUpdate())
