...
public abstract class Theme implements Nameable {
	...
	private final Texture icons = new Texture("icons.png");

	private final Map<Class<? extends Component>, ComponentRenderer<?>> renderers = new HashMap<>();
	
	private final Map<Class<? extends NodeTreeComponent<?>>, NodeRenderer<?>> nodeTreeRenderers = new HashMap<>();
