...
public class GuiHuzuniChat extends GuiNewChat {
                    ...
                    if (chatline != null)
                    {
                        ...
                        if (j1 < 200 || flag)
                        {
                            ...
                            if (l1 > 3)
                            {
                                ...
                                drawStringWithShadow(huzuni.friendManager.replaceName(s), (float)i2, (float)(j2 - 8), 16777215 + (l1 << 24));
    ...
    private int getStringWidth(String text) {
    	return mc.fontRendererObj.getStringWidth(huzuni.friendManager.replaceName(text));
